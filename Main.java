...
public class Main { 
    ...
    static String song = "./love/CKay - Love Nwantiti.wav"; 
...
Long Rewound = (input.nextLong()*1000); 
    ...
    public static void Search() { 
        ...
        Songlist[0] = "./love/CKay - Love Nwantiti.wav"; 
        Songlist[1] = "./love/Migos - T-Shirt .wav"; 
        Songlist[2] = "./love/DJ Khaled-Hold you down.wav";
